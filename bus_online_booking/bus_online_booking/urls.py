...
urlpatterns = [
    ...
    # path('allbus/',views.Showbus.as_view(),name='allbus'),
    ...
    path('cancleticket/',views.Cancleboooking.as_view(),name='cancleticket'),
    path('deletepassenger/<int:id>/',views.Deletepessenger.as_view(),name='deletepassenger'),
    # path('ticketshow/',views.LogoutView.as_view(),name='ticketshow'),
